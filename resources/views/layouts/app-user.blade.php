        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header d-flex align-items-center">
                <a class="navbar-brand" href="/">
                    ...
                    <h2 class=" text-blue border-4">Tukuo</h2>
                </a>
                <div class="ml-auto">
                    <!-- Sidenav toggler -->
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link {{request()->is('dashboard/downloads') ? 'text-blue' : ''}}"
                                href='/dashboard/downloads'>
                                <i class="ni ni-ungroup text-orange"></i>
                                <span class="nav-link-text hove">Downloads</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{request()->is('dashboard/products') ? 'text-blue' : ''}}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{request()->is('dashboard/transactions') ? 'text-blue' : ''}}"
        ...
        <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <h3><a class=" text-white pr-3 large-4" href="/">{{ Auth::user()->seller ? '': 'Tukuo'}}</a>
                    </h3>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-xl dropdown-menu-right py-0 overflow-hidden">
                                ...
                                <div class="list-group list-group-flush">
                                    <a href="tables.html#!" class="list-group-item list-group-item-action">
